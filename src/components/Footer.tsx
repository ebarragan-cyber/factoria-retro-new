...
export default function Footer({ onPageChange }: FooterProps) {
  const socialLinks = [
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@FactoriaRetro',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            fill="currentColor"
            d="M23.498 6.186a2.974 2.974 0 00-2.09-2.106C19.691 3.5 12 3.5 12 3.5s-7.691 0-9.408.58a2.974 2.974 0 00-2.09 2.106A31.363 31.363 0 000 12a31.363 31.363 0 00.502 5.814 2.974 2.974 0 002.09 2.106C4.309 20.5 12 20.5 12 20.5s7.691 0 9.408-.58a2.974 2.974 0 002.09-2.106A31.363 31.363 0 0024 12a31.363 31.363 0 00-.502-5.814zM9.75 15.02V8.98L15.5 12l-5.75 3.02z"
          />
        </svg>
      ),
    },
    {
      name: 'X',
      href: 'https://x.com/MiFactoriaRetro',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            fill="currentColor"
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@factoria.retro',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            fill="currentColor"
            d="M14.75 2a5.25 5.25 0 004.36 2.21v2.3a7.5 7.5 0 01-3.5-.86v8.35a5.75 5.75 0 11-5.75-5.75c.31 0 .62.03.92.09v2.48a2.69 2.69 0 102.18 2.62V2h1.79z"
          />
        </svg>
      ),
    },
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/factoria.retro2023',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            fill="currentColor"
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/groups/957556555770713?locale=es_ES',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            fill="currentColor"
